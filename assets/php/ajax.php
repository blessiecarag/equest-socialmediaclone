...
// ajax to retrieve data if user have followed other users
...
// ajax to retrieve data if user have unfollowed other users
...
// ajax to retrieve data if user have liked posts
if(isset($_GET['like'])){
...
// ajax to retrieve data if user have unliked posts
...
// ajax to retrieve data if user have added comments
...
// ajax to retrieve data if user have searched for other users
